...
public class StringProblems {
	 ...
	 */
	public int isPalindrome11(String str) {
	...
	public boolean isPalindrome12(String s) {
	...
	public boolean isPalindrome13(String s) {
		...
		while (l < h) {
			...
			if (!Character.isLetterOrDigit(chHead)) {
				...
				if (Character.toLowerCase(chHead) != Character.toLowerCase(chTail)) return false;
				l++;
				h--;
			}
		}
